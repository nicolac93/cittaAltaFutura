			...
			<main class="container">
			  <div class="row">
				...
				<div class="col-12 text-center mt-5">
					...
					<p>Il Comune ha coinvolto il team di ricerca del CST nella creazione di un <strong>processo partecipativo</strong> con lo scopo di sottoporre agli abitanti intesi come residenti e city-users (pendolari, commercianti, studenti, visitatori e turisti) una <strong>revisione del Piano Particolareggiato di Città Alta</strong> volto a dare una risposta ai loro bisogni e al contempo promuovere una valorizzazione delle potenzialità territoriali del centro storico visto come polo di una città reticolare e multicentrica.</p>
